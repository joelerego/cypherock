                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell style={{color: "#FFF"}} align="right">{row.fat}</TableCell>
                      <TableCell style={{color: "#FFF"}} align="right">{row.carbs}</TableCell>
                      <TableCell style={{color: "#FFF"}} align="right">{row.protein}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
